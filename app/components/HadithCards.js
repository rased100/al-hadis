...
const HadithCards = async ({ books, chapters, hadith, section }) => {
  ...
  return (
    <div className="text-black  rounded-xl ml-5">
      <div>
      ...
      {booksData.map((book) => (
        <div
          className="flex items-center bg-white pl-5 pr-3 py-4 rounded-b-xl mb-3"
          key={book.id}
        >
          {/* <Image
          ...
          <div className="pr-3 rounded-xl">
            <div>
              <svg
                className="xss:w-9 xs:w-9 sm:w-9 sm:h-9 st-current"
      ...
      {chapterData.map((singelChapter) => (
        <div key={singelChapter.id}>
          <div className="flex items-center bg-white px-5 py-3 rounded-xl my-3">
            <h1 className="bg-[#45ac85] text-white mr-3 py-2 px-4 rounded-xl text-md">
